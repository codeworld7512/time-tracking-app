...
export function CustomDrawerContent() {
  ...
  const handleNavigate = (to, screen) => {
    setActive(to);
    if (screen) navigation.navigate(to, screen);
  ...
  return (
    <DrawerContentScrollView>
      ...
      <Drawer.Item
        ...
        onPress={() =>
          handleNavigate("HourRegistrations", { screen: "Overview" })
        }
      />
      {HoursShowselfcertified && (
        <Drawer.Item
          ...
          onPress={() =>
            handleNavigate("SelfcertfiedHours", { screen: "Overview" })
          }
        />
      )}
      {HoursShowsickleave && (
        <Drawer.Item
          ...
          onPress={() => handleNavigate("SickLeave", { screen: "Overview" })}
        />
      )}
      {HoursShowmovableholiday && (
        <Drawer.Item
          ...
          onPress={() =>
            handleNavigate("MovableHolidays", { screen: "Overview" })
          }
        />
      )}
      <Drawer.Item
